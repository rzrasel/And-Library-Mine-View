...
public class ArmorReversePaginationTemp extends LinearLayout {
    ...
    public ArmorReversePaginationTemp(Context argContext) {
        this(argContext, null);
    }

    public ArmorReversePaginationTemp(Context argContext, AttributeSet argAttrs) {
        this(argContext, argAttrs, 0);
    }

    public ArmorReversePaginationTemp(Context argContext, AttributeSet argAttrs, int argDefStyleAttr) {
    ...
    public ArmorReversePaginationTemp setCurrentPage(int argCurrentPage) {
        this.currentPage = argCurrentPage - 1;
        return this;
    }

    public ArmorReversePaginationTemp setTotalNumOfItems(int argTotalNumOfItems) {
        this.totalNumOfItems = argTotalNumOfItems;
        return this;
    }

    public ArmorReversePaginationTemp setPagerClickListener(ArmorPagination.OnPagerClickListener argOnPagerClickListener) {
        this.onPagerClickListener = argOnPagerClickListener;
        return this;
    }

    public ArmorReversePaginationTemp setNumOfItemsPerPage(int argNumOfItemsPerPage) {
        this.numOfItemsPerPage = argNumOfItemsPerPage;
        return this;
    }

    public ArmorReversePaginationTemp initSetReverse() {
        int val = totalNumOfItems % numOfItemsPerPage;
        val = (val == 0) ? 0 : 1;
        numOfPages = totalNumOfItems / numOfItemsPerPage + val;
        if (currentPage <= 0) {
