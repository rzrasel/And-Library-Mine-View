...
import com.rz.usagesexample.BuildConfig;
...
public class UIYouTubePlayerFragment extends YouTubePlayerFragment implements YouTubePlayer.OnInitializedListener, YouTubePlayer.PlayerStateChangeListener, YouTubePlayer.PlaybackEventListener {
    ...
    private static final String STATE_LAST_POSITION_MILLIS = UIYouTubePlayerFragment.class.getPackage().getName() + ".state_last_millis";
    private static final String STATE_WAS_PLAYING = UIYouTubePlayerFragment.class.getPackage().getName() + ".state_was_playing";

    private static final String ARG_VIDEO_YOUTUBE_ID = UIYouTubePlayerFragment.class.getPackage().getName() + ".arg_video_youtube_id";
    private static final String ARG_GOOGLE_API_KEY = UIYouTubePlayerFragment.class.getPackage().getName() + ".arg_google_api_key";
    private static final String ARG_THEME_RESOURCE_ID = UIYouTubePlayerFragment.class.getPackage().getName() + ".arg_theme_id";
    private static final String ARG_ENABLE_LOGGING = UIYouTubePlayerFragment.class.getPackage().getName() + ".arg_enable_logging";
     ...
     */
    public static UIYouTubePlayerFragment newInstance(@NonNull String youtubeId,
                                                      @NonNull String apiKey,
                                                      @Nullable @StyleRes Integer themeResourceId,
                                                      boolean enableDebugLogging) {
        UIYouTubePlayerFragment frag = new UIYouTubePlayerFragment();
    ...
    public UIYouTubePlayerFragment() {
    }
    ...
    private class PlayerControlsPopupWindow extends PopupWindow implements SeekBar.OnSeekBarChangeListener {
         ...
         *
         * @param state Any of the constants in {@link UIYouTubePlayerFragment.PlayerControlsPopupWindow.PlayPauseButtonState}
         */
         ...
         *
         * @return Any of the constants in {@link UIYouTubePlayerFragment.PlayerControlsPopupWindow.PlayPauseButtonState}
         */
         ...
         *                     Should be between 0 and {@link UIYouTubePlayerFragment.PlayerControlsPopupWindow#getSeekBarMax()}, inclusive
         */
