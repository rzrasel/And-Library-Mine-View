...
public class RSVPMediaController extends FrameLayout {
...
//    private boolean mFullscreenEnabled = false;
    ...
    public RSVPMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.RSVPMediaController);
        mScalable = a.getBoolean(R.styleable.RSVPMediaController_rsvp_scalable, false);
        a.recycle();
        init(context);
    }

    public RSVPMediaController(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.rsvp_player_controller, this);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.rsvp_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.rsvp_stop_btn);
            //mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.rsvp_player_player_btn);
            //mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.rsvp_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.drawable.rsvp_player_scale_btn);
        }
    }
