...
public class AngularProgressView extends View {
    ...
    public AngularProgressView(Context context) {
        this(context, null);
    }

    public AngularProgressView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AngularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.AngularProgressView);
            figurePadding = array.getDimensionPixelSize(R.styleable.AngularProgressView_apv_figure_padding, DEFAULT_FIGURE_PADDING);
            numberOfAngles = array.getInteger(R.styleable.AngularProgressView_apv_number_of_angles, DEFAULT_NUMBER_OF_ANGLES);
            setColor(array.getColor(R.styleable.AngularProgressView_apv_color, Color.parseColor(DEFAULT_COLOR)));
            duration = array.getInteger(R.styleable.AngularProgressView_apv_duration, DEFAULT_DURATION);
            int typeInt = array.getInt(R.styleable.AngularProgressView_apv_type, 0);
            switch (typeInt) {
                case 0:
                    type = TYPE.KITE;
                    break;
